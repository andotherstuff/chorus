...
const Index = () => {
  ...
  if (!currentUser) {
    return (
      <>
        <div className="min-h-[calc(100vh-3rem)] md:min-h-screen flex flex-col items-center justify-center bg-background dark:bg-dark-background p-8">
  ...
  if (currentUser && newUser) {
    return (
      <OnboardingContext.Provider value={{ generatedName }}>
        <div className="min-h-[calc(100vh-3rem)] md:min-h-screen flex flex-col items-center justify-center bg-background dark:bg-dark-background">
